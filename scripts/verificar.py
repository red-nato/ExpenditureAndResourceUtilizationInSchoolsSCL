...
dim=pd.read_csv(P/'pme_resumen_dimensiones_2024.csv')
check('Dimensiones PME conservan acciones y estimaciones',
      dim.acciones.sum()==len(x) and dim.estimacion_total_clp.sum()==x.ESTIM_TOTAL.sum())
